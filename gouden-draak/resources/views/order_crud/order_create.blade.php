...
{{--        <a class="btn btn-dark text-white" href="{{ route('RepeatOrder') }}">Herhaal een vorige bestelling</a>--}}
        ...
        <div class="form-group">
            <form method="POST" class="bg-menu mb-0" action="{{ url('order-store') }}">
                @csrf
                <div class="table-responsive">
                    <table class="table table-borderless" id="dynamic_field">
                        <tr>
                            <td>
                                <label for="tableNumber">Tafel nummer</label>
                                <select id="tableNumber" name="tableNumber" class="form-control ">
